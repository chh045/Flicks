...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // create a storyboard to connect with the Main.storyboard
        ...
        //nowPlayingViewController.tabBarItem.image = UIImage(contentsOfFile: "now_playing")
        ...
        //topRatedViewController.tabBarItem.image = UIImage(contentsOfFile: "top_rated")
